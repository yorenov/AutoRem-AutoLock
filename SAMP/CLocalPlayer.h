...
public:
    ...
    static int& RefIncarSendrate();  // = NETMODE_INCAR_SENDRATE;
    static int& RefOnfootSendrate(); // = NETMODE_ONFOOT_SENDRATE;
    static int& RefFiringSendrate(); // = NETMODE_FIRING_SENDRATE;
    static int& RefSendMultiplier(); // = NETMODE_SEND_MULTIPLIER;
